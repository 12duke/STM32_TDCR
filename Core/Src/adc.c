...
/* USER CODE BEGIN 0 */
#define ADC3_OVERSAMPLING_RATIO_256 256
/* USER CODE END 0 */
...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  hadc1.Init.Oversampling.Ratio = ADC3_OVERSAMPLING_RATIO_256;
...
void MX_ADC2_Init(void)
{
  ...
  */
  ...
  hadc2.Init.Oversampling.Ratio = ADC3_OVERSAMPLING_RATIO_256;
